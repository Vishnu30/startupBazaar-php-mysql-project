...
@media (min-width: 1024px) {
    ...
    <body>
        ...
        $name = $_POST['name'];
        $pwd = $_POST['password'];
        $sql = "SELECT * FROM investor WHERE username LIKE '%$name%' AND password LIKE '%$pwd%' ";
              ...
              <div class="navbar-header">
                   ...
                   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                          <li class="active"><a href="editinvestor.php">edit profile<span class="sr-only">(current)</span></a></li>
                          <li><a href="showmessages.php?id=<?php echo $name?>">messages</a></li>
                          <li><a href="investorlogin.html">logout</a></li>
                      </ul>
